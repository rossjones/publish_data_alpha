...
//    .submitFormAndCheckNextTitle('Your dataset has been published')
  ...
  'Create a dataset, other licence, leave input empty' : function (browser) {
    ...
    .setValue('input[id=id_licence_other]', 'other licence')
    .submitFormAndCheckNextTitle('Choose an area')
    .end();
  },
  ...
  'Create a dataset, frequency weekly' : function (browser) {
    ...
    .submitFormAndCheckNextTitle('Add a link')
    .setValue('input[id=id_url]', 'http://example.com/file.csv')
    .setValue('input[id=id_title]', 'First link')
    .setValue('input[id=start_day]', '30')
    .setValue('input[id=start_month]', '01')
    .setValue('input[id=start_year]', '2012')
    .setValue('input[id=end_day]', '30')
    .setValue('input[id=end_month]', '01')
    .setValue('input[id=end_year]', '2013')
    .submitFormAndCheckNextTitle('Dataset links')
    .clickOnLink('Add another file')
    .setValue('input[id=id_url]', 'http://example.com/file2.csv')
    .setValue('input[id=id_title]', 'Second link')
    .setValue('input[id=start_day]', '30')
    .setValue('input[id=start_month]', '01')
    .setValue('input[id=start_year]', '2013')
    .setValue('input[id=end_day]', '30')
    .setValue('input[id=end_month]', '01')
    .setValue('input[id=end_year]', '2014')
    .submitFormAndCheckNextTitle('Dataset links')
  ...
  'Create a dataset, frequency monthly' : function (browser) {
    ...
    .setValue('input[id=id_title]', 'First link')
    .setValue('input[id=period_month]', '12')
    .setValue('input[id=period_year]', '2012')
    .submitFormAndCheckNextTitle('Dataset links')
    .clickOnLink('Add another file')
    .setValue('input[id=id_url]', 'http://example.com/file2.csv')
    .setValue('input[id=id_title]', 'Second link')
    .setValue('input[id=period_month]', '12')
    .setValue('input[id=period_year]', '2013')
    .submitFormAndCheckNextTitle('Dataset links')
    .assert.containsText('table', 'First link')
    .assert.containsText('table', 'Second link')
    .end();
